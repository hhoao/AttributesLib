...
public class ALObjects {
    ...
    public static class Attributes {
         ...
         */
        public static final RegistryObject<Attribute> ARMOR_PIERCE =
                R.attribute(
                        "armor_pierce",
                        () ->
                                new RangedAttribute(
         ...
         * calculations.
         */
        public static final RegistryObject<Attribute> ARMOR_SHRED =
                R.attribute(
                        "armor_shred",
                        () ->
         ...
         *
         * <p>Arrow damage scales with the velocity as well as {@link #ARROW_DAMAGE} and the base
         * damage of the arrow entity.
         */
         ...
         * "Melee" damage is considered as damage from another entity within the player's attack
         * range.
         *
         * <p>This includes projectile attacks, as long as the projectile actually impacts the
         * player.
         */
         ...
         * damage calculations.
         */
        public static final RegistryObject<Attribute> PROT_PIERCE =
                R.attribute(
                        "prot_pierce",
                        () ->
         ...
         */
        public static final RegistryObject<Attribute> PROT_SHRED =
                R.attribute(
                        "prot_shred",
                        () ->
                                new PercentBasedAttribute(
    ...
    public static class MobEffects {
        ...
        /**
         * Bleeding inflicts 1 + level damage every two seconds. Things that apply bleeding usually
         * stack.
         */
        ...
        /**
         * Flaming Detonation, when it expires, consumes all fire ticks and deals armor-piercing
         * damage based on the duration.
         */
        public static final RegistryObject<DetonationEffect> DETONATION =
                R.effect("detonation", DetonationEffect::new);

        /** Grievous Wounds reduces healing received by 40%/level. */
        public static final RegistryObject<GrievousEffect> GRIEVOUS =
         ...
         */
        public static final RegistryObject<SunderingEffect> SUNDERING =
                R.effect("sundering", SunderingEffect::new);

        /** Bursting Vitality increases healing received by 20%/level. */
        public static final RegistryObject<VitalityEffect> VITALITY =
