...
public class ALConfig {
    ...
    public static void load() {
        ...
        enableAttributesGui =
                cfg.getBoolean(
                        "Enable Attributes GUI",
                        "general",
                        true,
                        "If the Attributes GUI is available.");
        enablePotionTooltips =
                cfg.getBoolean(
                        "Enable Potion Tooltips",
                        "general",
                        true,
     ...
     *
     * <p>Expressions are orders of magnitudes more expensive to evaluate when compared to the
     * relevant java code, so do not use them unless absolutely necessary.
     *
     * @param args A list of argument names used by the expression, to sanity-check execution.
     * @return An optional containing the configured expression, or an empty optional if the default
     *     was used or an exception occurred.
     */
    private static Optional<Expression> readConfigExpression(
            Configuration cfg,
            String key,
            String group,
            String defaultValue,
        ...
        try {
            ...
            AttributesLib.LOGGER.error(
                    "Ignoring invalid {} entry {} as the expression failed to evaluate.",
                    key,
                    exprStr);
            ex.printStackTrace();
            return Optional.empty();
