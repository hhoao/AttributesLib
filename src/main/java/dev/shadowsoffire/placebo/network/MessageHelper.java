...
public class MessageHelper {
    ...
    /**
     * Registers a message directly using the base FML systems. Requires providing each method
     * individually.
     *
     ...
     * @param channel Channel to register for.
     * @param id Message id.
     * @param prov An instance of the message provider. Note that this object will be kept around,
     *     so try to keep all fields uninitialized if possible.
     */
    @SuppressWarnings("unchecked")
    public static <T> void registerMessage(SimpleChannel channel, int id, MessageProvider<T> prov) {
        channel.registerMessage(
                id,
                (Class<T>) prov.getMsgClass(),
                prov::write,
                prov::read,
                prov::handle,
                prov.getNetworkDirection());
    }

    /**
     * Handles a packet. Enqueues the runnable to run on the main thread and calls {@link
