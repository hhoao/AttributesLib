 ...
 * is, reading, writing, and handling.
 *
...
public interface MessageProvider<T> {
     ...
     * errors. See {@link MessageHelper#handlePacket(Supplier, Supplier)}
     *
     ...
     *
     * @return The optional containing the valid network direction, or empty if both directions are
     *     supported.
