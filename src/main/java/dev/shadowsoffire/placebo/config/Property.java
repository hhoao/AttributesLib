...
public class Property {
    ...
    public boolean isDefault() {
        if (this.isBooleanList()) {
            if (this.values.length == this.defaultValues.length) {
                for (int i = 0; i < this.values.length; i++)
                    if (Boolean.parseBoolean(this.values[i])
                            != Boolean.parseBoolean(this.defaultValues[i])) return false;
        ...
        if (this.isDoubleList()) {
            if (this.values.length == this.defaultValues.length) {
                for (int i = 0; i < this.values.length; i++)
                    if (Double.parseDouble(this.values[i])
                            != Double.parseDouble(this.defaultValues[i])) return false;
    ...
    /**
     * Sets the flag for whether or not this Property can be edited while a world is running. Care
     * should be taken to ensure that only properties that are truly dynamic can be changed from the
     * in-game options menu. When set to false the Property will be editable from both the main menu
     * Mods list config screen and the in-game Mod Options config screen. When set to true the
     * Property will only be editable from the main menu Mods list config screen.
     */
    ...
    /**
     * Returns whether or not this Property is able to be edited while a world is running using the
     * in-game Mod Options screen as well as the Mods list screen, or only from the Mods list
     * screen. Setting this flag to true will disable editing of this property while a world is
     * running.
     */
    ...
    /**
     * Gets whether or not this Property should be allowed to show on config GUIs. Defaults to true
     * unless set to false.
     */
    ...
    /**
     * Sets whether or not this Property requires Minecraft to be restarted when changed. Defaults
     * to false. Setting this flag to true will also disable editing of this property while a world
     * is running.
     */
    ...
    /**
     * Gets whether or not this Property requires Minecraft to be restarted when changed. Defaults
     * to false unless set to true.
     */
    ...
    /**
     * Sets the maximum length of this list/array Property. Only important if isList() == true. If
     * the current values array or default values array is longer than the new maximum it will be
     * resized. If calling both this method and setIsListLengthFixed(true), this method should be
     * called afterwards (but is not required).
     */
    public Property setMaxListLength(int max) {
        this.maxListLength = max;
        if (this.maxListLength != -1) {
            if (this.values != null && this.values.length != this.maxListLength)
                if (this.isListLengthFixed || this.values.length > this.maxListLength)
                    this.values = Arrays.copyOf(this.values, this.maxListLength);

            if (this.defaultValues != null && this.defaultValues.length != this.maxListLength)
                if (this.isListLengthFixed || this.defaultValues.length > this.maxListLength)
    ...
    /**
     * Sets the flag for whether this list/array Property has a fixed length. Only important if
     * isList() == true. If calling both this method and setMaxListLength(), this method should be
     * called first (but is not required).
     */
    ...
    /**
     * Returns whether or not this list/array has a fixed length. Only important if isList() ==
     * true.
     */
    ...
    /**
     * Sets a regex Pattern object used to validate user input for formatted String or String[]
     * properties.
     *
    ...
    /**
     * Sets the localization language key for this Property so that the config GUI screens are nice
     * and pretty <3. The string languageKey + ".tooltip" is used for tooltips when a user hovers
     * the mouse over a GUI property label.
     *
    ...
    public Property setDefaultValues(String[] defaultValues) {
        this.defaultValue = "";
        for (String s : defaultValues) this.defaultValue += ", [" + s + "]";
        this.defaultValue = this.defaultValue.replaceFirst(", ", "");
    ...
    public Property setDefaultValues(int[] defaultValues) {
        ...
        for (int i = 0; i < defaultValues.length; i++) temp[i] = Integer.toString(defaultValues[i]);
    ...
    public Property setDefaultValues(double[] defaultValues) {
        String[] temp = new String[defaultValues.length];
        for (int i = 0; i < defaultValues.length; i++) temp[i] = Double.toString(defaultValues[i]);
    ...
    public Property setDefaultValues(boolean[] defaultValues) {
        String[] temp = new String[defaultValues.length];
        for (int i = 0; i < defaultValues.length; i++) temp[i] = Boolean.toString(defaultValues[i]);
    ...
    /**
     * Sets the array of valid values that this String Property can be set to. When an array of
     * valid values is defined for a Property the GUI control for that property will be a value
     * cycle button.
     *
    ...
    /**
     * Gets the array of valid values that this String Property can be set to, or null if not
     * defined.
     *
    ...
    /**
     * Returns the value in this property as an integer, if the value is not a valid integer, it
     * will return the initially provided default.
     *
     * @return The value
     */
    public int getInt() {
    ...
    /**
     * Returns the value in this property as an integer, if the value is not a valid integer, it
     * will return the provided default.
     *
    ...
    /**
     * Returns the value in this property as a long, if the value is not a valid long, it will
     * return the initially provided default.
     *
     * @return The value
     */
    public long getLong() {
    ...
    /**
     * Returns the value in this property as a boolean, if the value is not a valid boolean, it will
     * return the provided default.
     *
    ...
    /**
     * Returns the value in this property as a double, if the value is not a valid double, it will
     * return the provided default.
     *
     ...
     * This is useful for mods who auto-assign their blocks to determine if the ID returned is a
     * configured one, or a automatically generated one.
     *
    ...
    public Property setValues(boolean[] values) {
        ...
        for (int i = 0; i < values.length; i++) this.values[i] = String.valueOf(values[i]);
        this.changed = true;
        return this;
    }
